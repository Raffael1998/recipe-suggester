...
Add as many basic ingredients and utensils as possible so the recommender knows
what you usually have available but is not overly constrained.
...
base ingredients and utensils. The app uses `streamlit-audiorecorder` for a
microphone interface with playback controls (falling back to
`streamlit-mic-recorder` if necessary). Make sure your browser allows
microphone access. You can manage your ingredient and utensil lists from the
main interface below the request section.
